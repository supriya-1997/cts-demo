            ...
            <div className="input-group mb-3">
              <div className="input-group-prepend">
                ...
                <div className="dropdown-menu">
                  ...
                  < Link to="/" style={{ color: 'black' }}>Wmomen's Fashion</Link><br />
          ...
          <div className="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <div className="row" style={{ width: "600px" }}>
              <div className="col-xl-6">
                ...
                <div className="dropdown-item" >Your Orders</div>
                <div className="dropdown-item" >Buy Again</div>
                <hr />
                <div className="dropdown-item" >Your Recommendations</div>
                <div className="dropdown-item" >Your Subscribe & Save Items</div>
                <div className="dropdown-item" >Memberships & Subscriptions</div>
                <div className="dropdown-item">Your Service requests</div>
                <div className="dropdown-item" >Your Garage</div>
                <div className="dropdown-item" >Your Fanshop</div>
                <div className="dropdown-item" >Your Pets</div>
                <div className="dropdown-item">Your Content & devices</div>
                <div className="dropdown-item" >Your Music Library</div>

                <div className="dropdown-item" >Your Amazon Drive</div>
                <div className="dropdown-item" >Your Prime Video</div>
                <div className="dropdown-item" >Your Kindle Unlimited</div>
                <div className="dropdown-item" >Your Watchlists</div>
                <div className="dropdown-item" >Your Video purchases & rentals</div>
                <div className="dropdown-item">Your Android Apps & devices</div>
                <br />
                <br />
                <hr />
              ...
              <div className="col-xl-6">
                <div className="dropdown-item" >Your Lists</div>
                <div className="dropdown-item" >Create a List</div>
                <div className="dropdown-item" >Find a List or Registry</div>

                <div className="dropdown-item" >Find a Gift</div>
                <div className="dropdown-item" >Save Items from the Web</div>
                <div className="dropdown-item" >Wedding registry</div>
                <div className="dropdown-item" >baby registry</div>
                <div className="dropdown-item" >Friends & Family Gifting</div>
                <div className="dropdown-item" >AmazonSmile Charity Lists</div>
                <div className="dropdown-item" >Pantry Lists</div>
                <div className="dropdown-item" >Your Hearts</div>
                <div className="dropdown-item" >Explore Idea Lists</div>
                <div className="dropdown-item" >Explore Showroom</div>
                <div className="dropdown-item" >Take the Home Style Quiz</div>
                <br />
                <br />
                <br />
                <br />
                ...
                <br />
                <hr />
                <div className="dropdown-item" >New Customer?Start Here</div>

                <Link to="/Login"> <div className="dropdown-item" href="#">Sign in</div></Link>
              </div>
            ...
            <div className="row">
              ...
              <div className="col text-dark" >
                ...
                <Link to="/delivery"><b className="text-dark">Delivery to India</b></Link>
                    ...
                    {/*<div className="col-sm-2">  <Link to="/mobile"><b class="text-dark">Mobiles</b></Link></div>*/}
