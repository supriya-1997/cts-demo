            ...
            <div id="carouselExampleControls" className="carousel slide " data-ride="carousel">
                <div className="carousel-inner">
                  ...
                  <span style={{}}>You are on amazon.com. You can also shop on Amazon India for millions of products with fast local delivery <a href="#">Click here to go to amazon.in</a></span>
                        ...
                        <img src="https://images-na.ssl-images-amazon.com/images/G/01/AmazonExports/Fuji/2020/March/Fuji_TallHero_ShipATW_Modified_en_US_1x._CB419795291_.jpg" className="img-fluid" style={{ width: "100%", height: "400px" }} alt="slide 1" />
                        <div className="carousel-caption d-none d-md-block text-center"><p style={{ backgroundColor: 'white', width: '100%', height: '40px', color: 'black' }}>You are on amazon.com. You can also shop on Amazon India for millions of products with fast local delivery Click here to go to amazon.in</p></div>
                        {/* <h1>Hello</h1>*/}
                    </div>
...
{/*<h1>Hello</h1>*/}
                        <img src="https://images-na.ssl-images-amazon.com/images/G/01/AmazonExports/Fuji/2019/April/Hero/Hero_Currency_EN_1X._CB466692681_.jpg" className="img-fluid" style={{ width: "100%", height: "400px" }} alt="slide 2" />
                        <div className="carousel-caption d-none d-md-block text-center"><p style={{ backgroundColor: 'white', width: '100%', height: '40px', color: 'black' }}>You are on amazon.com. You can also shop on Amazon India for millions of products with fast local delivery Click here to go to amazon.in</p></div>
                    </div>
                </div>
                ...
                <div className="col-3">
                    ...
                    <div className="card ml-3" style={{ width: "18rem", height: "20rem" }}>
                        ...
                        <div className="card-body">
                            ...
                            <br />
                            <br />
                            <div className="text-primary">Shop now</div>
                        </div>
                    </div>
                </div>
                <div className="col-3">
                ...
                <div className="col-3">
                    <div className="card ml-3" style={{ width: "18rem", height: "20rem" }}>
                        ...
                        <div className="card-body">
                            ...
                            <div className="row">
                                <div className="col-lg-12 col-md-6 col-sm-12">
                                    <div className="btn btn-block btn-warning ml-3">Sign in securely</div>
