        ...
        <>
            <div className="row">
                <div className="col-sm-3">
                    ...
                    <div>
                        {!!quantity && (
                            <button type="submit" onClick={() => decrementCounter(index)} className="btn btn-sm "><img src="https://cdn1.iconfinder.com/data/icons/round-black-icons-2/78/minus-512.png" width="25px" height="25px" /></button>

                        )}
                                &nbsp;
                        <span className="badge badge-white">{quantity}</span> &nbsp;
                        <button type="submit" onClick={() => incrementCounter(index)} className="btn btn-sm "><img src="https://cdn1.iconfinder.com/data/icons/round-black-icons-2/78/plus-512.png" width="25px" height="25px" /></button>
